...
import ShohrehImage from "../assets/images/Shohreh.jpg";
...
const People = () => {
  const fakeLabMembers = [
    ...
    },
    {
        ...
        "email": "haddadan.Shohreh@moffitt.org",
        "photo": ShohrehImage,
        "type": "Applied Research Scientist",
        "info": "Shohreh earned her master's degree in computational linguistics from Sharif University of Technology before relocating to Luxembourg in 2017 to pursue her Ph.D. studies. She successfully obtained her doctoral degree in Computer Science from the University of Luxembourg in 2022. Her doctoral research focused on argument mining in political debates, utilizing Natural Language Processing methods to extract argument structures from text and employing them to classify fallacious arguments. Transitioning seamlessly into the role of a data scientist, she participated in research endeavors as part of an industrial project in collaboration with Zortify S.A. research lab and the Interdisciplinary Centre for Security, Reliability, and Trust (SnT) at the University of Luxembourg focusing on the adaptation of Large Language Models in domain-specific and low-resource settings. Shohreh's research interests span a wide spectrum, with a particular emphasis on argument mining and abstractive summarization."
    },
    {
        "id": 4,
        "name": "Thanh Duong",
